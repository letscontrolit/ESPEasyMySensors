...
//        Device[deviceCount].Type = DEVICE_TYPE_I2C;
    ...
    case PLUGIN_INIT:
      {
        ...
        present(event->BaseVarIndex, S_DUST);
        Serial.print("Present ADS1115 Dust: ");
        Serial.println(event->BaseVarIndex);
        msgDust025 = new MyMessage(event->BaseVarIndex, V_LEVEL);
 ...
 uint16_t config = (0x0003)    |  // Disable the comparator (default val)
  ...
  //      config |= (0x0000);
        ...
        send(msgDust025->set(UserVar[event->BaseVarIndex], 1));
